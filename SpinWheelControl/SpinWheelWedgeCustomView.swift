...
open class SpinWheelWedgeView: UIView {
    ...
    @objc open func configureWedgeLabel(index: UInt, width: CGFloat, position: CGPoint, orientation:WedgeLabelOrientation, radiansPerWedge: Radians) {
